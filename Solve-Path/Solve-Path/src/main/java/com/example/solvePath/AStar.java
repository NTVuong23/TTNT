...
public class AStar {
    ...
    public void solve() {
        ...
        startNode.g = 0;
        startNode.calculateF(); // Tính toán f cho node bắt đầu
        ...
        while (!FRINGE.isEmpty()) {
            ...
            for (Node child : CHILD) {
                ...
                child.g = currentNode.g + child.cost; // Tính g cho node con
                child.h = child.estimate(goalNode.state); // Tính h cho node con
                child.calculateF(); // Tính toán f cho node con
                ...
                FRINGE.add(0, child); // Thêm node con vào FRINGE
            }
            CHILD.clear();
            approvedNodes++;
        }
